...
h = plot(time_axis, exp(err_avg), "-o", 'LineWidth', 5, 'Color',"red");
...
% legend(h, {"Inertia. $N = $" + lagrange_info(1) + ", $St=$" + lagrange_info(2) + ", $c = $" + lagrange_info(3) + "$\times u^*$. Average result."}, "Interpreter","latex")
